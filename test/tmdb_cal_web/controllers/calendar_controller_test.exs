defmodule TmdbCalWeb.CalendarControllerTest do
  use TmdbCalWeb.ConnCase
  import TmdbCal.Fixtures

  test "GET /calendar.ics returns correct content type", %{conn: conn} do
    conn = get(conn, ~p"/calendar.ics")
  ...
  test "GET /calendar.ics returns the correct format", %{conn: conn} do
